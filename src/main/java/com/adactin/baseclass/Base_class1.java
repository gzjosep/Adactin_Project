			...
			if (browser.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver", 
				 ...
				 driver = new ChromeDriver();
					 ...
					 System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + ("\\DriverFirefox\\geckodriver.exe"));
...
//			}
	     	...
	     	public static void screenshot(String path) throws IOException {
	          ...
	          public static void dropDown(WebElement element, String Options, String Value) {
				...
				try {
					if (Options.equals("byIndex")) {
						int parseInt = Integer.parseInt(Value);
						s.selectByIndex(parseInt);
						} else if (Options.equals("byValue")) {
							s.selectByValue(Value);
						} else if (Options.equals("byVisibleText")) {
